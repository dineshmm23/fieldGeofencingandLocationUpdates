...
public class LocationUpdatesComponent {
     ...
     */
    private static final long UPDATE_INTERVAL_IN_MILLISECONDS = 1 * 1000;
    ...
    public void onCreate(Context context) {
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                String loaction_updates = locationResult.getLocations().get(0).getLatitude() + "," + locationResult.getLocations().get(0).getLongitude();
                LatLng latLng = new LatLng(locationResult.getLocations().get(0).getLatitude(), locationResult.getLocations().get(0).getLongitude());
                Log.d(TAG, "onLocationResult: " + loaction_updates);
